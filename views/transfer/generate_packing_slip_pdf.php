...
class PDF extends FPDF {
  ...
  function ItemTableBody() {
    ...
    foreach ($this->details as $row) {
      ...
      // Kolom Description
      $desc_lines = $this->NbLines(84, $desc);
      $desc_h = $desc_lines * 5;
      $desc_y_offset = ($h - $desc_h) / 2;
      $this->Rect($x, $y, 85, $h);
      $this->SetXY($x + 1, $y + $desc_y_offset); // MultiCell start position, centered vertically
      $this->MultiCell(83, 5, $desc, 0, 'L');
      $x += 85;
  ...
  function SignatureSection() {
    ...
    $this->Cell(47.5, 6, 'Meri Mentari', 1, 0, 'C');
